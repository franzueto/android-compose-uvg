...
data class IngredientsCategoriesResponse(val meals: List<IngredientsResponse>)

data class IngredientsResponse(
    @SerializedName("idMeal") val id: String,
    @SerializedName("strMeal") val name2: String,
    @SerializedName("strDrinkAlternate") val description: String,
    @SerializedName("strCategory") val imageUrl2: String,
    @SerializedName("strInstructions") val instructions: String,


    @SerializedName("strArea") val area: String,
    @SerializedName("strMealThumb") val imageUrl3: String,
